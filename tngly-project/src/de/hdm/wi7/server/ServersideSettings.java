...
public class ServersideSettings extends CommonSettings{
	...
	/**
	   ...
	   * saemtliches Logging im Code und koennen ohne abermaliges Kompilieren den Log
	   * Level "von aussen" durch die Datei <code>logging.properties</code> steuern.
	   * Sie finden diese Datei in dem <code>war/WEB-INF</code>-Ordner Ihres
	   * Projekts. Der dort standardmaessig vorgegebene Log Level ist
